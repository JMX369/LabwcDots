...
printf '%b\n' '
  ...
  <menu id="Preferences" label="Preferences" icon="applications-engineering">
    <item label="Edit rc.xml" name.action="Execute" command.action="greany ~/.config/labwc/rc.xml" icon="text-x-generic" />
    <item label="Edit autostart" name.action="Execute" command.action="greany ~/.config/labwc/autostart" icon="text-x-generic" />
  </menu>
